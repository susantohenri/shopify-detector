 ...
 * Shopify Detector
 *
 * @package     ShopifyDetector
 * @author      Henri Susanto
 * @copyright   2022 Henri Susanto
 * @license     GPL-2.0-or-later
 *
 * @wordpress-plugin
 * Plugin Name: Shopify Detector
 * Plugin URI:  https://github.com/susantohenri
 * Description: Detect URL Shopify & Apps
 * Version:     1.0.0
 * Author:      Henri Susanto
 * Author URI:  https://github.com/susantohenri
 * Text Domain: shopifydetector
...
add_action('rest_api_init', function () {
    register_rest_route('shopify-detector/v1', '/detect', array(
        'methods' => 'POST',
        'callback' => function () {
            ...
            $allJavascripts = $domXpath->query("//html//script");
            $javascriptWithSRC = [];
            foreach ($allJavascripts as $script) {
                $src = $script->getAttribute('src');
                if ('' !== $src) $javascriptWithSRC[] = $src;
            }

            foreach ($javascriptWithSRC as $script) {
                if (preg_match_all("/cdn[0-9]*\.bigcommerce\.[a-z]+/i", $script)) {
                    $response['platform'] =  'bigcommerce';
                } else if (preg_match_all("/cdn[0-9]*\.shopify\.[a-z]+/i", $script)) {
                    $response['platform'] =  'shopify';
                } else if (preg_match_all("/mage\/cookies\.js/i", $script)) {
                    $response['platform'] =  'magento1';
                } else if (preg_match_all("/mage\/polyfill(\.min)?\.js/i", $script)) {
                    $response['platform'] =  'magento2';
                } else if (preg_match_all("/woocommerce/i", $script)) {
                    $response['platform'] =  'woocommerce';
                } else if (preg_match_all("/services\/wix-/i", $script)) {
                    $response['platform'] =  'wix';
                }
            }
            ...
            $appList = [
                [
                    "name" => "Fera.ai",
                    "short_description" =>
                    "Customer reviews, photos, counters, events, etc",
                    "long_description" =>
                    "Collect and grow your customer reviews, photos, videos, testimonials, and more.",
                ...
                [
                    ...
                    "short_description" =>
                    "Let customers reserve products online for in-store pickup",
                ...
                [
                    "name" => "Privy",
                    "short_description" =>
                    "Free email popups, exit intent, targeted modals, wheels & more",
                ...
                [
                    ...
                    "app_store_url" =>
                    "https://apps.shopify.com/jilt-cart-abandonment-solution",
                ...
                [
                    "name" => "Conversio",
                    "short_description" =>
                    "Email Marketing Automation. Make every email count",
                ...
                [
                    "name" => "MailChimp",
                    "short_description" =>
                    "MailChimp list with exit intent popups and coupons",
                ...
                [
                    ...
                    "short_description" =>
                    "Boost your marketing tactics with Google Ads by Clever Adwords",
                ...
                [
                    ...
                    "short_description" =>
                    "Grow your email list with customizable bar, and boost sales",
                ...
                [
                    ...
                    "website_url" => "https://www.mailmunch.co",
                    "script_pattern" =>
                    "widgets/site-519579-1d4a0439b676bb9b4e1159635561fda7fb2c0857.js",
                    "category" => "Marketing",
                ],
                [
                    "name" => "Pixelpop",
                ...
                [
                    ...
                    "short_description" =>
                    "Let your customer be your promoter, abandoned cart on whatsapp",
                ...
                [
                    "name" => "OptinMate",
                    "short_description" =>
                    "Email Collection, Coupons & Social Popups, Bards & Cards",
                ...
                [
                    "name" => "Refersion",
                    "short_description" =>
                    "Track referrals & pay commissions to affiliates + influencers",
                ...
                [
                    "name" => "RetargetApp",
                    "short_description" =>
                    "Get more sales and new customers with automated Facebook ads",
                    "app_store_url" =>
                ...
                [
                    ...
                    "website_url" =>
                    "https://help.shopify.com/en/manual/apps/apps-by-shopify/product-reviews",
                ...
                [
                    "name" => "Firepush",
                    "short_description" =>
                    "Order recovery with SMS and FREE Web push notifications",
                ...
                [
                    ...
                    "short_description" =>
                    "Amazon-like Bundle Recommendations, Upsell and Discounts",
                    "app_store_url" =>
                ...
                [
                    ...
                    "script_pattern" =>
                    "storefront/2.0.0/js/shopify/checkout-tracker.min.js",
                    "category" => "Sales",
                ],
                [
                    "name" => "McAfee SECURE",
                ...
                [
                    ...
                    "website_url" =>
                    "https://recovermycart.freshdesk.com/support/solutions/articles/33000213763-remember-my-cart-faq",
                ...
                [
                    "name" => "Wishy",
                    "short_description" =>
                    "A beautiful, advanced & customizable wishlist plugin",
                ...
                [
                    ...
                    "script_pattern" =>
                    "pxu-recent-sales-apps.s3.amazonaws.com/recent-sales",
                    "category" => "Sales",
                ],
                [
                    "name" => "MPS Buy Me",
                ...
                [
                    ...
                    "short_description" =>
                    "Product options to one or one thousand products with a click!",
                ...
                [
                    "name" => "Gift Wizard",
                    "short_description" =>
                    "Gift Card Solutions, Loyalty and Rewards, Store Credit",
                ...
                [
                    ...
                    "short_description" =>
                    "Review app for product reviews , photo reviews & site reviews",
                    "app_store_url" =>
                ...
                [
                    "name" => "In Cart Upsell",
                    "short_description" =>
                    "Laser targeted upsell offers in the shopping cart - no popups!",
                ...
                [
                    ...
                    "website_url" => "https://spur-i-t.com",
                    "script_pattern" =>
                    "shopify-extensions/social-proof/store/c54a5ad7c7b4a0069ca3eddae2a0406a.js",
                    "category" => "Sales",
                ],
                [
                    "name" => "Recovermycart",
                ...
                [
                    ...
                    "short_description" =>
                    "Minimum - Maximum limits on your products, groups or entire cart",
                ...
                [
                    ...
                    "short_description" =>
                    "Social Share and Messaging Buttons. Improve Your Communication",
                ...
                [
                    "name" => "Cartback",
                    "short_description" =>
                    "Facebook Messenger Abandoned Cart app and Messenger Marketing",
                ...
                [
                    ...
                    "script_pattern" =>
                    "files/1/0016/7591/9458/t/1/assets/ssw-libraries.js",
                    "category" => "Social media",
                ],
                [
                    "name" => "Expertvillagemedia.com Instagram Feed & Gallery",
                    "short_description" =>
                    "Top Instagram Gallery, Instagram Lookbook & Instagram Feed App",
                    "app_store_url" => "https://apps.shopify.com/instagram-feed",
                    "website_url" =>
                    "https://www.expertvillagemedia.com/shopify-apps/instafeed/",
                ...
                [
                    ...
                    "short_description" =>
                    "Photos Reviews, Wishlist, Instagram, Loyalty and 7 apps in one",
                ...
                [
                    "name" => "Kudobuzz",
                    "short_description" =>
                    "Testimonials and Reviews - Grow your business with social reviews",
                ...
                [
                    ...
                    "short_description" =>
                    "Grow your website with free tools trusted by over 15M sites",
                ...
                [
                    ...
                    "short_description" =>
                    "Instagram Feed or Embed any YouTube video and shaping video gallery",
                ...
                [
                    ...
                    "short_description" =>
                    "Shop your instagram! Create an Instagram shop in minutes",
                ...
                [
                    ...
                    "short_description" =>
                    "Instagram App to Add Instagram Gallery from Instagram Account",
                ...
                [
                    ...
                    "short_description" =>
                    "Free Mobile Messaging via WhatsApp, Messenger, Skype. SMS etc",
                    "app_store_url" =>
                    "https://apps.shopify.com/mobile-messaging-social-share-bar",
                    "website_url" => "https://info.zotabox.com/",
                    "script_pattern" => "a384d78e2f3e7d78c9d09a15f7f1b51e/widgets.js",
                    "category" => "Social media",
                ],
                ...
                [
                    ...
                    "short_description" =>
                    "Social Login - Use any Social Network platform to login to your store",
                ...
                [
                    ...
                    "short_description" =>
                    "Responsive Widget to display tweets, follow button",
                ...
                [
                    ...
                    "short_description" =>
                    "Add aliveness to your store by integrating Instagram\'s feeds",
                    "app_store_url" =>
                    "https://apps.shopify.com/instagram-feed-by-sketch-themes",
                    "website_url" => "",
                ...
                [
                    "name" => "TagTray",
                    "short_description" =>
                    "Shop Galleries Of Customer Generated Social Media Photos",
                ...
                [
                    ...
                    "short_description" =>
                    "Social Caller gives you a hand, to increase your inbound calls",
                ...
                [
                    ...
                    "app_store_url" =>
                    "https://apps.shopify.com/linkerfriend-lead-management-tools",
                ...
                [
                    ...
                    "app_store_url" =>
                    "https://apps.shopify.com/facebook-messenger-live-chat",
                    "website_url" => "https://info.zotabox.com",
                ...
                [
                    ...
                    "short_description" =>
                    "Take Less Than 2 Minutes to Get In Touch With Your Customers",
                ...
                [
                    ...
                    "short_description" =>
                    "Form Builder App with Custom Registration Form and Order Form",
                    "app_store_url" => "https://apps.shopify.com/form-builder",
                    "website_url" => "https://www.aaaecommerce.com/",
                    "script_pattern" =>
                    "formbuilder.aaawebstore.com/appfiles/aaa_form_builder_script_minify.js",
                    "category" => "Customer service",
                ],
                [
                ...
                [
                    "name" => "Re:amaze",
                    "short_description" =>
                    "Customer support helpdesk with live chat, ticketing, and FAQ",
                ...
                [
                    ...
                    "website_url" =>
                    "http://help.combidesk.com/instruction-manuals/shopify/instruction-manual-shopify-zendesk-chat-integration-formerly-zopim",
                ...
                [
                    "name" => "Pure Chat",
                    "short_description" =>
                    "Easy-to-use live chat software with unlimited users and chats",
                ...
                [
                    ...
                    "short_description" =>
                    "Finally! Chats, FB messages, calls & emails, all in one app",
                ...
                [
                    ...
                    "short_description" =>
                    "Add extra fees to incease your sales and average order value",
                ...
                [
                    "name" => "Google Reviews",
                    "short_description" =>
                    "Add Google Customer Reviews to your site, no coding required!",
                    "app_store_url" =>
                    "https://apps.shopify.com/easy-google-customer-reviews",
                    "website_url" =>
                    "https://unionworks.co.uk/shopify-apps/easy-google-customer-reviews/support",
                ...
                [
                    ...
                    "short_description" =>
                    "Create any kind of custom form with Powerful Form Builder app",
                    "app_store_url" => "https://apps.shopify.com/powerful-form-builder",
                    "website_url" => "http://www.globosoftware.net",
                    "script_pattern" =>
                    "s/files/1/0016/7591/9458/t/1/assets/globoformbuilder_init.js",
                    "category" => "Customer service",
                ],
                [
                    "name" => "Delivery Date Range",
                    "short_description" =>
                    "Display the estimated delivery date range on the product page",
                ...
                [
                    ...
                    "short_description" =>
                    "Merchants can offer discounts to different customer groups",
                ...
                [
                    "name" => "Hubspot",
                    "short_description" =>
                    "Integrate marketing, sales, online data and more!",
                ...
                [
                    "name" => "SLoyalty",
                    "short_description" =>
                    "Reward customers, build loyalty and grow referral sales.",
                ...
                [
                    ...
                    "long_description" =>
                    "All-in-one Facebook pixel app that lets you integrate multiple pixels, add advanced event data, and see your ROI take off.",
                ...
                [
                    "name" => "Fomo",
                    "short_description" =>
                    "Increase Conversions with Social Proof Automation",
                ...
                [
                    ...
                    "short_description" =>
                    "Automatically apply discounts through a custom URL",
                ...
                [
                    ...
                    "short_description" =>
                    "Stylish favicon notification to reduce cart abandonment",
                ...
                [
                    ...
                    "short_description" =>
                    "Quantity Breaks,Tiered Pricing and Bulk Discounts",
                ...
                [
                    "name" => "Full Page Zoom",
                    "short_description" =>
                    "High quality full screen image zoom for high quality images",
                    "app_store_url" => "https://apps.shopify.com/full-page-zoom",
                    "website_url" => "https://www.codeblackbelt.com",
                    "script_pattern" =>
                    "cdn.codeblackbelt.com/js/modules/full-page-zoom/main.min.js",
                    "category" => "Store Design",
                ],
                [
                    "name" => "Checkout Share",
                    ...
                    "script_pattern" =>
                    "checkoutshare.spacesquirrel.net/embed_share_a_purchase.js",
                    "category" => "Sales",
                ],
                [
                    "name" => "ReCharge",
                ...
                [
                    ...
                    "app_store_url" =>
                    "https://www.klarna.com/international/business/shopify",
                    "website_url" =>
                    "https://www.klarna.com/international/business/shopify",
                ...
                [
                    ...
                    "short_description" =>
                    "Set Up Back in Stock Notifications for Out of Stock Products",
                ...
                [
                    ...
                    "website_url" => "https://www.pixelunion.net",
                    "script_pattern" =>
                    "apps.pixelunion.net/scripts/js/countdown/bundle.min.js",
                    "category" => "Sales",
                ],
                [
                ...
                [
                    ...
                    "script_pattern" =>
                    "shopify.webkul.com/multivendor/js/download_prod.js",
                    "category" => "Products",
                ],
                [
                    "name" => "Pixlee",
                ...
                [
                    ...
                    "website_url" =>
                    "https://www.theshoppad.com/infinite-options-for-shopify",
                ...
                [
                    ...
                    "website_url" => "",
                    "script_pattern" =>
                    "variant-image-automator.starapps.studio/product_variants.js",
                    "category" => "Store Design",
                ],
                [
                ...
                [
                    ...
                    "website_url" => "http://www.codeinero.net",
                    "script_pattern" =>
                    "preorderly.azurewebsites.net/Scripts/preorder.min.js",
                    "category" => "Orders",
                ],
                [
                    "name" => "Messenger",
                ...
                [
                    ...
                    "website_url" => "https://www.codeblackbelt.com",
                    "script_pattern" =>
                    "cdn.codeblackbelt.com/js/modules/shipping-rates-calculator-plus",
                    "category" => "Orders",
                ],
                [
                    "name" => "Shoelace",
                ...
                [
                    ...
                    "short_description" =>
                    "Dramatically enhance your ADD TO CART and CHECKOUT process",
                    "app_store_url" => "https://apps.shopify.com/sticky-add-to-cart-bar",
                    "website_url" => "http://www.codeinero.net",
                    "script_pattern" =>
                    "stickyaddtocartbar.azurewebsites.net/Scripts/satcb.min.js",
                    "category" => "Store Design",
                ],
                [
                ...
                [
                    ...
                    "short_description" =>
                    "Easily add options, variants & customization to your products",
                ...
                [
                    ...
                    "short_description" =>
                    "Sell more with a loyalty program and automated email marketing",
                ...
                [
                    "name" => "Uploadery",
                    "short_description" =>
                    "Give your customers the ability to send files with their order",
                ...
                [
                    "name" => "Shop The Look",
                    "short_description" =>
                    "Help your customers Buy the Look and purchase multiple items",
                ...
                [
                    ...
                    "website_url" =>
                    "https://www.goldendev.win/shopify/add-to-cart/support",
                ...
                [
                    ...
                    "website_url" => "https://www.codeblackbelt.com",
                    "script_pattern" =>
                    ".codeblackbelt.com/js/modules/cool-image-magnifier",
                    "category" => "Store Design",
                ],
                [
                ...
                [
                    ...
                    "script_pattern" =>
                    "app1pro.b-cdn.net/relatedproduct/js/relatedproduct.min.js",
                    "category" => "Sales",
                ],
                [
                    ...
                    "app_store_url" =>
                    "https://apps.shopify.com/partners/developer-dd332b77623f4d86",
                    "website_url" => "https://leadslide.com",
                ...
                [
                    ...
                    "short_description" =>
                    "Add Countdown Timer your Store & generate Urgency",
                ...
                [
                    "name" => "Revy - UpSell",
                    "short_description" =>
                    "Increase & Maximize average order value and sales with UpSell",
                    "app_store_url" =>
                ...
                [
                    "name" => "Cart Activity",
                    "short_description" =>
                    "Get a newsfeed of what shoppers are doing on your site",
                ...
                [
                    ...
                    "short_description" =>
                    "Generate more sales through upsells with our simple upsell app",
                ...
                [
                    "name" => "Nextsale",
                    "short_description" =>
                    "Social Proof, Increase Sales Pop Timers Social Proof and hurry",
                ...
                [
                    ...
                    "short_description" =>
                    "Bundle products together with discounts and make more sales!",
                    "app_store_url" =>
                ...
                [
                    ...
                    "short_description" =>
                    "Responsive banner slider, slideshow, image gallery",
                ...
                [
                    ...
                    "short_description" =>
                    "Ultimate Quantity Discounts & Tiered Pricing Rule for Products",
                    "app_store_url" =>
                ...
                [
                    ...
                    "short_description" =>
                    "Establish trust and security to increase sales conversions",
                ...
                [
                    ...
                    "short_description" =>
                    "Upsell Bundles, Before Checkout or After Payment",
                ...
                [
                    ...
                    "short_description" =>
                    "Product bundles: make higher value offers and get more sales!",
                ...
                [
                    ...
                    "short_description" =>
                    "Convert more customers with the convenience of texting",
                ...
                [
                    ...
                    "short_description" =>
                    "Sales Pop to boost sale & social proof with live sales pop up",
                    "app_store_url" =>
                ...
                [
                    ...
                    "website_url" => "https://autoketing.com",
                    "script_pattern" =>
                    "product-discount-dot-autoketing-production-sdk.appspot.com/dist/product-discount-embed.js",
                    "category" => "Sales",
                ],
                [
                    ...
                    "website_url" => "https://autoketing.com",
                    "script_pattern" =>
                    "upsell-master-dot-autoketing-production-sdk.appspot.com/dist/upsell-master-embed.js",
                    "category" => "Sales",
                ],
                [
                ...
                [
                    ...
                    "short_description" =>
                    "Back In Stock product notifications via email, SMS, FB Messenger and Push",
                    "app_store_url" =>
                ...
                [
                    "name" => "PickyStory",
                    "short_description" =>
                    "Automate Upsell & Cross-Sell of Bundles, Kits, and Looks",
                    "long_description" =>
                    "Generate more revenue from every store visit. Sell Shopify product Bundles, Kits, and Looks with one app. It’s easy and done in a few clicks.",
                    "app_store_url" =>
                ...
                [
                    "name" => "Vitals",
                    "short_description" =>
                    "Combo app: Upsells, Reviews, Bundles, BOGO, etc",
            ...
            foreach ($appUrl as $url) {
                foreach ($appList as $app) {
                    if (is_array($app['script_pattern'])) {
                        ...
                        if (preg_match("/^\/.+\/[a-z]*$/i", $app['script_pattern'])) {
                            if (!preg_match($app['script_pattern'], $url)) continue;
                        } else {
                            if (!strpos($url, $app['script_pattern'])) continue;
                        }
                    }
                    $response['apps'][] = $app;
                }
